...
namespace OpenSim.Region.ClientStack.LindenUDP
{
    public static class AuroraTerrainCompressor
    {
        ...
        /// <returns></returns>
        public static LayerDataPacket CreateLandPacket(float[] heightmap, int[] x, int[] y, byte type, int RegionSizeX,
                                                       int RegionSizeY)
        {
            LayerDataPacket layer = new LayerDataPacket { LayerID = { Type = type } };
        ...
        public static void CreatePatch(BitPack output, float[] patchData, int x, int y, int RegionSizeX, int RegionSizeY)
        {
            ...
            wbits = EncodePatchHeader(output, header, patch, (int)Constants.RegionSize, (int)Constants.RegionSize, wbits);
        ...
        /// <param name="RegionSizeX"></param>
        /// <param name="RegionSizeY"></param>
        public static void CreatePatchFromHeightmap(BitPack output, float[] heightmap, int x, int y, int RegionSizeX,
                                                    int RegionSizeY)
        {
